...
int main() {
    ...
    cout << a - b << endl;
    cout << b - a << endl;
    //std::string x = "8049784293012435984230243954983420";
    //std::string y = "-1110000000000000000000000000000000";
    //std::cout<<BigInteger(x)+BigInteger(y);
